...
<template>
  <div id="search">
	...
	<!--	<button class="btn btn-outline-info searchUser" @click="searchUser">搜索用户</button>-->
	<div class="choose">
	...
	<div id="hotSearch">
	  ...
	  <span id="hotSearchResults" v-for="item in hotSearchResults">
		<a @click.prevent="updateKeyword(item.first)">{{ item.first }}</a>
	  </span>
	</div>
...
<script>
  import {hotSearch, musicCover, searchMusic, search} from "../network/Top";
