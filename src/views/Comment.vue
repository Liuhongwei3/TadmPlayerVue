<template>
  <div id="comments">
    <el-tag type="warning" @click="changeshowCloudCommentsFlag">云村热评</el-tag>
    ...
    <div id="hotComments">
      ...
      <div class="commentItems" v-for="item in hotComments">
        <el-avatar size="medium" :src="item.user.avatarUrl" @click="updateUserId(item.user.userId)"/>
...
<script>
  import {cloudHotComments, songComment, songHotComment} from "@/network/Request";
