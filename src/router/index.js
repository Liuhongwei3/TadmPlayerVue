...
const routes = [
    ...
    },
    {
        ...
        name: "History",
        component: () =>
            import(/* webpackChunkName: "1" */ "@/views/History.vue"),
    },
    {
        path: "/comment",
        name: "Comment",
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "2" */ "../components/content/ShowMv.vue"
            ),
    },
    {
        path: "/showVideo",
        ...
        component: () =>
            import(
                /* webpackChunkName: "2" */ "../components/content/ShowVideo.vue"
            ),
    },
    {
        path: "/album",
        name: "Album",
        component: () =>
            import(/* webpackChunkName: "2" */ "@/views/Album.vue"),
    },
    {
        path: "/about",
        name: "About",
